...
export default function Toggle({ deletePost, setToggle }: ToggleProps) {
	return (
		...
		>
			<div className="absolute bg-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 p-12 rounded-lg flex flex-col gap-6">
				<h2 className="text-xl">
					Are you sure you want to delete this post? 🥺
				</h2>
				<h3 className="text-red-600 text-sm">
					Pressing the delete button will permanently remove the post
				</h3>
				<button
					onClick={() => {
						deletePost()
